        ...
        if research_line_id == 'null':
            ...
            if request.args.get('type_operation', '') == 'A':
                try:
                    ...
                    outfile_path = os.path.join(ttl_path, f'kg_{project_name}.ttl')
...
def loadDictionaryMappingByName(project_name):
    ...
    if os.path.exists(csv_file):
        ...
        if data and data[0] == [
            'Column', 'Attribute', 'attributeOf', 'Entity', 'Unit', 'Format',
            'Property', 'Time', 'Relation', 'inRelationTo', 'Label', 'Role',
            'Definition', 'Comment', 'wasDerivedFrom', 'wasGeneratedBy'
        ]:
            data = data[1:]
